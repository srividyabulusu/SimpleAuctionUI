...
<body>
	...
	<form id="form" action="custName" onclick="#" method="post">
	 	<fieldset>
			<legend><b><i>Please enter the following information</i></b></legend>
		 	<table>
		 		...
		 		<tr>
		 			<td><label>Enter New Name of Customer: </label> </td>
		 			<td><input type="text" name="custName" id="custName" placeholder="active"> </td>
		 		</tr>
		 		<tr>
